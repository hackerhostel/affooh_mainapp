          ...
          <div className='w-3/4'>
            ...
            <form className="mt-4 space-y-6" ref={formRef} onSubmit={login}>
              ...
              <div className='flex justify-between w-full py-4'>
                ...
                <Link to="/forgot-password" className="text-md text-primary-pink">Forgot password</Link>
              </div>
              <button
                type="submit"
                className="btn-login flex justify-center items-center h-12"
                disabled={loading}
              >
                {loading ? <Spinner className="w-6 h-6 text-white animate-spin fill-white" /> : "Login"}
              </button>
            </form>
