...
const UserRoles = () => {
  ...
  const handleAddNew = () => {
    console.log('Navigating to add user role');
    history.push('/settings/user-roles/add');
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <h4 className="text-md font-semibold text-gray-900">User Roles</h4>
        <button
          onClick={handleAddNew}
          className="flex items-center px-4 py-2 bg-primary-pink text-white rounded-md hover:bg-secondary-pink transition-colors duration-200"
        >
